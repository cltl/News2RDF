...
class ConceptMention:
    ...
    def __init__(self, sentence, mention,
        ...
        self.mention_offset_ranges = mention_offset_ranges # e.g. list of tuples
        self.provenance = provenance
...
class NewsItem:
    ...
    def __init__(self, identifier, collection,
        ...
        self.domain = domain          # e.g. {"crime"}  -> topics/domains (we could also use URI identifiers for these if we want to keep more information)
